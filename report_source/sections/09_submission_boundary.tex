\section{第三部分 完成情况与性能参数（二）：提交材料与公开边界}
...
\subsection{重要代码包边界}
重要代码包采用“真实项目代码、非核心公开边界”的原则：上传可审查的公网展示站静态前端、报告图表生成脚本、工位碰撞互锁与仿真逻辑、接口 schema、公开演示适配层和说明文档。它不再是几 KB 的形式文件，但仍不公开以下内容：
\begin{itemize}
...
\begin{warnbox}
报告、视频和公开代码包统一避免“首创”“全国首个”“完全自主”“绝对安全”“替代实验员”等绝对化措辞，统一使用“真机实测”“工程验证”“本项目实现”“shadow mode”“安全降级”等可防守表述。
\end{warnbox}
